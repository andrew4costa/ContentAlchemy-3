          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-8">
                ...
                <a href="#pricing" className="text-slate-600 hover:text-brand-blue px-3 py-2 text-sm font-medium transition-colors">Pricing</a>
                <Button 
      ...
      <section id="pricing" className="py-20 bg-slate-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              See why independent creators choose ContentFlow over complex, expensive alternatives.
            </p>
          </div>
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead className="bg-slate-50">
                  <tr>
                    <th className="text-left p-6 font-semibold text-slate-800 w-1/4">Feature</th>
                    <th className="text-center p-6 font-semibold text-brand-blue">ContentFlow AI</th>
                    <th className="text-center p-6 font-semibold text-slate-600">Repurpose.io</th>
                    <th className="text-center p-6 font-semibold text-slate-600">ContentFries</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-slate-200">
                  <tr>
                    <td className="p-6 font-medium text-slate-700">Pricing (monthly)</td>
                    <td className="p-6 text-center text-brand-blue font-bold">$29</td>
                    <td className="p-6 text-center text-slate-600">$199</td>
                    <td className="p-6 text-center text-slate-600">$97</td>
                  </tr>
                  <tr className="bg-slate-25">
                    <td className="p-6 font-medium text-slate-700">Setup Required</td>
                    <td className="p-6 text-center">
                      <X className="text-brand-green text-xl mx-auto mb-1" />
                      <span className="text-brand-green font-medium">None</span>
                    </td>
                    <td className="p-6 text-center">
                      <Check className="text-red-500 text-xl mx-auto mb-1" />
                      <span className="text-red-500 font-medium">Complex</span>
                    </td>
                    <td className="p-6 text-center">
                      <Check className="text-red-500 text-xl mx-auto mb-1" />
                      <span className="text-red-500 font-medium">Technical</span>
                    </td>
                  </tr>
                  <tr>
                    <td className="p-6 font-medium text-slate-700">Context Understanding</td>
                    <td className="p-6 text-center">
                      <Check className="text-brand-green text-xl mx-auto mb-1" />
                      <span className="text-brand-green font-medium">Advanced AI</span>
                    </td>
                    <td className="p-6 text-center">
                      <X className="text-red-500 text-xl mx-auto mb-1" />
                      <span className="text-red-500 font-medium">Templates</span>
                    </td>
                    <td className="p-6 text-center">
                      <X className="text-red-500 text-xl mx-auto mb-1" />
                      <span className="text-red-500 font-medium">Basic</span>
                    </td>
                  </tr>
                  <tr className="bg-slate-25">
                    <td className="p-6 font-medium text-slate-700">Platform Adaptation</td>
                    <td className="p-6 text-center">
                      <Check className="text-brand-green text-xl mx-auto mb-1" />
                      <span className="text-brand-green font-medium">Automatic</span>
                    </td>
                    <td className="p-6 text-center">
                      <X className="text-red-500 text-xl mx-auto mb-1" />
                    ...
                    <td className="p-6 text-center">
                      <X className="text-red-500 text-xl mx-auto mb-1" />
                      <span className="text-red-500 font-medium">Limited</span>
                    </td>
                  </tr>
                  <tr>
                    <td className="p-6 font-medium text-slate-700">Time to Results</td>
                    <td className="p-6 text-center">
                      <Check className="text-brand-green text-xl mx-auto mb-1" />
                      <span className="text-brand-green font-medium">2 minutes</span>
                    </td>
                    <td className="p-6 text-center">
                      <X className="text-red-500 text-xl mx-auto mb-1" />
                      <span className="text-red-500 font-medium">30+ minutes</span>
                    </td>
                    <td className="p-6 text-center">
                      <X className="text-red-500 text-xl mx-auto mb-1" />
                      <span className="text-red-500 font-medium">15+ minutes</span>
                    </td>
                  </tr>
                </tbody>
              </table>
